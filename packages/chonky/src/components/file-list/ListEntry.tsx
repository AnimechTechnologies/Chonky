...
export const ListEntry: React.FC<ListEntryProps> = React.memo(
  ({ file, selected, focused, renaming, dndState, columns }) => {
    const entryState: FileEntryState = useFileEntryState(file, selected, focused, renaming);
      ...
      <div className={classes.listFileEntry} {...fileEntryHtmlProps}>
        ...
        {columns.map((column, index) => (
          ...
          >
            ...
            {column.render === 'name' && (
              <FileEntryName file={file} renaming={renaming} />
            )}
